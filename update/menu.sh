...
echo -e "${BB}————————————————————————————————————————————————————————${NC}"
echo -e "  ${RB}♦️${NC} ${YB}Traffic\e[0m       ${YB}Today       ${YB}Yesterday    ${YB}Month "
echo -e "  ${RB}♦️${NC} ${YB}Download\e[0m     $y $dtoday    $dyest     $dmon $wh "
echo -e "  ${RB}♦️${NC} ${YB}Upload\e[0m       $y $utoday    $uyest     $umon $wh "
echo -e "  ${RB}♦️${NC} ${YB}Total\e[0m        $y $ttoday    $tyest     $tmon $wh "
echo -e "${BB}————————————————————————————————————————————————————————${NC}"
